...
class ApplicationsActivity : AppCompatActivity(), SearchView.OnQueryTextListener {
    ...
    private fun initUi() {
        contentLoadingProgressBar = findViewById(R.id.progress_applications)
        ...
        recyclerView = findViewById<RecyclerView>(R.id.applications).apply {
    ...
    private fun checkStoreAccess(sendEmailVerification: Boolean = false, reloadUser: Boolean = false) {
        ...
        Firebase.database.store().addListenerForSingleValueEvent(
